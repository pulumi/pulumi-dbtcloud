...
class IpRestrictionsRuleArgs:
    def __init__(__self__, *,
                 ...
                 rule_set_enabled: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.bool] rule_set_enabled: Whether the IP restriction rule set is enabled or not. Important!: This value needs to be the same for all rules if multiple rules are defined. All rules must be active or inactive at the same time.
        :param pulumi.Input[builtins.str] type: The type of the IP restriction rule (allow or deny)
        :param pulumi.Input[builtins.str] description: A description of the IP restriction rule
        :param pulumi.Input[builtins.str] name: The name of the IP restriction rule
        """
    ...
    def rule_set_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def rule_set_enabled(self, value: pulumi.Input[builtins.bool]):
...
class _IpRestrictionsRuleState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 rule_set_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="ruleSetEnabled")
    def rule_set_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the IP restriction rule set is enabled or not. Important!: This value needs to be the same for all rules if multiple rules are defined. All rules must be active or inactive at the same time.
        """
        return pulumi.get(self, "rule_set_enabled")
    ...
    @rule_set_enabled.setter
    def rule_set_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "rule_set_enabled", value)
...
class IpRestrictionsRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rule_set_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'IpRestrictionsRule':
        """
    ...
    @property
    @pulumi.getter(name="ruleSetEnabled")
    def rule_set_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the IP restriction rule set is enabled or not. Important!: This value needs to be the same for all rules if multiple rules are defined. All rules must be active or inactive at the same time.
        """
        return pulumi.get(self, "rule_set_enabled")

...
class TeradataCredentialArgs:
    def __init__(__self__, *,
                 ...
                 threads: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a TeradataCredential resource.
        :param pulumi.Input[builtins.str] password: The password for the Teradata account
        :param pulumi.Input[builtins.int] project_id: Project ID to create the Teradata/Trino credential in
        :param pulumi.Input[builtins.str] schema: The schema where to create models
        :param pulumi.Input[builtins.str] user: The username for the Teradata account
        :param pulumi.Input[builtins.int] threads: The number of threads to use. Default is 1
        """
    ...
    @property
    @pulumi.getter
    def threads(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @threads.setter
    def threads(self, value: Optional[pulumi.Input[builtins.int]]):
...
class TeradataCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schema: Optional[pulumi.Input[builtins.str]] = None,
            threads: Optional[pulumi.Input[builtins.int]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None) -> 'TeradataCredential':
        """
    ...
    @property
    @pulumi.getter
    def threads(self) -> pulumi.Output[builtins.int]:
        """
        The number of threads to use. Default is 1
        """
        return pulumi.get(self, "threads")

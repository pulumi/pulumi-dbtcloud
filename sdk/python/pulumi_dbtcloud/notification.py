...
class NotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] on_failures: List of job IDs to trigger the webhook on failure
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] on_successes: List of job IDs to trigger the webhook on success
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] on_warnings: List of job IDs to trigger the webhook on warning
        :param pulumi.Input[_builtins.str] slack_channel_id: The ID of the Slack channel to receive the notification. It can be found at the bottom of the Slack channel settings
        :param pulumi.Input[_builtins.str] slack_channel_name: The name of the slack channel
        :param pulumi.Input[_builtins.int] state: State of the notification (1 = active (default), 2 = inactive)
        """
...
class Notification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            slack_channel_name: Optional[pulumi.Input[_builtins.str]] = None,
            state: Optional[pulumi.Input[_builtins.int]] = None,
            user_id: Optional[pulumi.Input[_builtins.int]] = None) -> 'Notification':
        """

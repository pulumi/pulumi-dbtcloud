...
class AccountFeaturesArgs:
    ...
    def advanced_ci(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def partial_parsing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def partial_parsing(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "partial_parsing", value)

    @property
    @pulumi.getter(name="repoCaching")
    def repo_caching(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
...
class AccountFeatures(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="advancedCi")
    def advanced_ci(self) -> pulumi.Output[builtins.bool]:
        """
        Whether advanced CI is enabled.
        """
        return pulumi.get(self, "advanced_ci")
    ...
    @property
    @pulumi.getter(name="partialParsing")
    def partial_parsing(self) -> pulumi.Output[builtins.bool]:
        """
        Whether partial parsing is enabled.
        """
        return pulumi.get(self, "partial_parsing")
    ...
    @property
    @pulumi.getter(name="repoCaching")
    def repo_caching(self) -> pulumi.Output[builtins.bool]:
        """
        Whether repository caching is enabled.
        """
        return pulumi.get(self, "repo_caching")

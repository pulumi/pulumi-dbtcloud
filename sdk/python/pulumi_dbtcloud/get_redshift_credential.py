...
def get_redshift_credential(credential_id: Optional[builtins.int] = None,
...
def get_redshift_credential_output(credential_id: Optional[pulumi.Input[builtins.int]] = None,

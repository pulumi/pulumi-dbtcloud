...
__all__ = [
    'GetRedshiftCredentialResult',
    'AwaitableGetRedshiftCredentialResult',
    'get_redshift_credential',
    'get_redshift_credential_output',
]

@pulumi.output_type
class GetRedshiftCredentialResult:
    """
    A collection of values returned by getRedshiftCredential.
    """
    def __init__(__self__, credential_id=None, default_schema=None, id=None, is_active=None, num_threads=None, project_id=None):
...
class AwaitableGetRedshiftCredentialResult(GetRedshiftCredentialResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRedshiftCredentialResult(
...
def get_redshift_credential(credential_id: Optional[_builtins.int] = None,
                            default_schema: Optional[_builtins.str] = None,
                            project_id: Optional[_builtins.int] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRedshiftCredentialResult:
    """
    ...
    __args__['defaultSchema'] = default_schema
    __args__['projectId'] = project_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('dbtcloud:index/getRedshiftCredential:getRedshiftCredential', __args__, opts=opts, typ=GetRedshiftCredentialResult).value

    return AwaitableGetRedshiftCredentialResult(
...
def get_redshift_credential_output(credential_id: Optional[pulumi.Input[_builtins.int]] = None,
                                   default_schema: Optional[pulumi.Input[_builtins.str]] = None,
                                   project_id: Optional[pulumi.Input[_builtins.int]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRedshiftCredentialResult]:
    """
    Redshift credential data source
    ...
    __ret__ = pulumi.runtime.invoke_output('dbtcloud:index/getRedshiftCredential:getRedshiftCredential', __args__, opts=opts, typ=GetRedshiftCredentialResult)
    return __ret__.apply(lambda __response__: GetRedshiftCredentialResult(

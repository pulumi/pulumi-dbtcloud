...
def get_jobs(environment_id: Optional[_builtins.int] = None,
    ...
    :param _builtins.int environment_id: The ID of the environment for which we want to retrieve the jobs (one of `project_id` or `environment_id` must be set)
    :param _builtins.int project_id: The ID of the project for which we want to retrieve the jobs (one of `project_id` or `environment_id` must be set)
    """
    __args__ = dict()

...
class GlobalConnectionArgs:
    def __init__(__self__, *,
                 ...
                 oauth_configuration_id: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] oauth_configuration_id: External OAuth configuration ID (only Snowflake for now)
        :param pulumi.Input['GlobalConnectionPostgresArgs'] postgres: PostgreSQL connection configuration.
        :param pulumi.Input[builtins.str] private_link_endpoint_id: Private Link Endpoint ID. This ID can be found using the `privatelink_endpoint` data source
    ...
    def oauth_configuration_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def oauth_configuration_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _GlobalConnectionState:
    def __init__(__self__, *,
                 adapter_version: Optional[pulumi.Input[builtins.str]] = None,
                 apache_spark: Optional[pulumi.Input['GlobalConnectionApacheSparkArgs']] = None,
                 athena: Optional[pulumi.Input['GlobalConnectionAthenaArgs']] = None,
                 bigquery: Optional[pulumi.Input['GlobalConnectionBigqueryArgs']] = None,
                 databricks: Optional[pulumi.Input['GlobalConnectionDatabricksArgs']] = None,
                 fabric: Optional[pulumi.Input['GlobalConnectionFabricArgs']] = None,
                 is_ssh_tunnel_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 oauth_configuration_id: Optional[pulumi.Input[builtins.int]] = None,
                 postgres: Optional[pulumi.Input['GlobalConnectionPostgresArgs']] = None,
                 private_link_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['GlobalConnectionDatabricksArgs'] databricks: Databricks connection configuration
        :param pulumi.Input['GlobalConnectionFabricArgs'] fabric: Microsoft Fabric connection configuration.
        :param pulumi.Input[builtins.bool] is_ssh_tunnel_enabled: Whether the connection can use an SSH tunnel
        :param pulumi.Input[builtins.str] name: Connection name
        :param pulumi.Input[builtins.int] oauth_configuration_id: External OAuth configuration ID (only Snowflake for now)
        :param pulumi.Input['GlobalConnectionPostgresArgs'] postgres: PostgreSQL connection configuration.
        :param pulumi.Input[builtins.str] private_link_endpoint_id: Private Link Endpoint ID. This ID can be found using the `privatelink_endpoint` data source
    ...
    def adapter_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def adapter_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_ssh_tunnel_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_ssh_tunnel_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class GlobalConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="adapterVersion")
    def adapter_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of the adapter
        """
        return pulumi.get(self, "adapter_version")
    ...
    @property
    @pulumi.getter(name="isSshTunnelEnabled")
    def is_ssh_tunnel_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the connection can use an SSH tunnel
        """
        return pulumi.get(self, "is_ssh_tunnel_enabled")
    ...
    @property
    @pulumi.getter(name="oauthConfigurationId")
    def oauth_configuration_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        External OAuth configuration ID (only Snowflake for now)
        """
        return pulumi.get(self, "oauth_configuration_id")

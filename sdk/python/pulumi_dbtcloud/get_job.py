...
class GetJobResult:
    ...
    @property
    @pulumi.getter
    def triggers(self) -> Mapping[str, builtins.bool]:
        """
...
def get_job(job_id: Optional[builtins.int] = None,
            project_id: Optional[builtins.int] = None,
            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetJobResult:
    """
    Use this data source to access information about an existing resource.

    :param builtins.int job_id: ID of the job
    :param builtins.int project_id: ID of the project the job is in
    """
    __args__ = dict()
...
def get_job_output(job_id: Optional[pulumi.Input[builtins.int]] = None,

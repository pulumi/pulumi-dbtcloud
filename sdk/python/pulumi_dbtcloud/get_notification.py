...
class GetNotificationResult:
    ...
    def external_email(self) -> builtins.str:
        """
    ...
    def notification_id(self) -> builtins.int:
        """
    ...
    def notification_type(self) -> builtins.int:
        """
    ...
    def on_cancels(self) -> Sequence[builtins.int]:
        """
    ...
    def on_failures(self) -> Sequence[builtins.int]:
        """
    ...
    def on_successes(self) -> Sequence[builtins.int]:
        """
    ...
    def on_warnings(self) -> Sequence[builtins.int]:
        """
...
def get_notification(notification_id: Optional[builtins.int] = None,
    ...
    :param builtins.int notification_id: The ID of the notification
    """
    __args__ = dict()
...
def get_notification_output(notification_id: Optional[pulumi.Input[builtins.int]] = None,

...
def get_starburst_credential(credential_id: Optional[builtins.int] = None,
...
def get_starburst_credential_output(credential_id: Optional[pulumi.Input[builtins.int]] = None,

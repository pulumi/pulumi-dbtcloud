...
class PartialNotificationArgs:
    def __init__(__self__, *,
                 ...
                 external_email: Optional[pulumi.Input[builtins.str]] = None,
                 notification_type: Optional[pulumi.Input[builtins.int]] = None,
                 on_cancels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 on_failures: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 on_successes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 on_warnings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
        ...
        :param pulumi.Input[builtins.int] user_id: Internal dbt Cloud User ID. Must be the user_id for an existing user even if the notification is an external one [global]
        :param pulumi.Input[builtins.str] external_email: The external email to receive the notification [global, used as identifier]
        :param pulumi.Input[builtins.int] notification_type: Type of notification (1 = dbt Cloud user email (default): does not require an external_email ; 2 = Slack channel: requires `slack_channel_id` and `slack_channel_name` ; 4 = external email: requires setting an `external_email`) [global, used as identifier]
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] on_cancels: List of job IDs to trigger the webhook on cancel. Those will be added/removed when config is added/removed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] on_failures: List of job IDs to trigger the webhook on failure Those will be added/removed when config is added/removed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] on_successes: List of job IDs to trigger the webhook on success Those will be added/removed when config is added/removed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] on_warnings: List of job IDs to trigger the webhook on warning Those will be added/removed when config is added/removed.
        :param pulumi.Input[builtins.str] slack_channel_id: The ID of the Slack channel to receive the notification. It can be found at the bottom of the Slack channel settings [global, used as identifier]
        :param pulumi.Input[builtins.str] slack_channel_name: The name of the slack channel [global, used as identifier]
        :param pulumi.Input[builtins.int] state: State of the notification (1 = active (default), 2 = inactive) [global]
        """
    ...
    def external_email(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_email(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_email", value)

    @property
    @pulumi.getter(name="notificationType")
    def notification_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def notification_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "notification_type", value)

    @property
    @pulumi.getter(name="onCancels")
    def on_cancels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    @on_cancels.setter
    def on_cancels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "on_cancels", value)

    @property
    @pulumi.getter(name="onFailures")
    def on_failures(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    @on_failures.setter
    def on_failures(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "on_failures", value)

    @property
    @pulumi.getter(name="onSuccesses")
    def on_successes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    @on_successes.setter
    def on_successes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "on_successes", value)

    @property
    @pulumi.getter(name="onWarnings")
    def on_warnings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
    ...
    @on_warnings.setter
    def on_warnings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "on_warnings", value)

    @property
    @pulumi.getter(name="slackChannelId")
    def slack_channel_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def slack_channel_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "slack_channel_id", value)

    @property
    @pulumi.getter(name="slackChannelName")
    def slack_channel_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def slack_channel_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PartialNotification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            slack_channel_name: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.int]] = None,
            user_id: Optional[pulumi.Input[builtins.int]] = None) -> 'PartialNotification':
        """
    ...
    @property
    @pulumi.getter(name="externalEmail")
    def external_email(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The external email to receive the notification [global, used as identifier]
        """
        return pulumi.get(self, "external_email")
    ...
    @property
    @pulumi.getter(name="notificationType")
    def notification_type(self) -> pulumi.Output[builtins.int]:
        """
        Type of notification (1 = dbt Cloud user email (default): does not require an external_email ; 2 = Slack channel: requires `slack_channel_id` and `slack_channel_name` ; 4 = external email: requires setting an `external_email`) [global, used as identifier]
        """
        return pulumi.get(self, "notification_type")
    ...
    @property
    @pulumi.getter(name="onCancels")
    def on_cancels(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        List of job IDs to trigger the webhook on cancel. Those will be added/removed when config is added/removed.
        """
        return pulumi.get(self, "on_cancels")
    ...
    @property
    @pulumi.getter(name="onFailures")
    def on_failures(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        List of job IDs to trigger the webhook on failure Those will be added/removed when config is added/removed.
        """
        return pulumi.get(self, "on_failures")
    ...
    @property
    @pulumi.getter(name="onSuccesses")
    def on_successes(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        List of job IDs to trigger the webhook on success Those will be added/removed when config is added/removed.
        """
        return pulumi.get(self, "on_successes")
    ...
    @property
    @pulumi.getter(name="onWarnings")
    def on_warnings(self) -> pulumi.Output[Sequence[builtins.int]]:
        """
        List of job IDs to trigger the webhook on warning Those will be added/removed when config is added/removed.
        """
        return pulumi.get(self, "on_warnings")
    ...
    @property
    @pulumi.getter(name="slackChannelId")
    def slack_channel_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Slack channel to receive the notification. It can be found at the bottom of the Slack channel settings [global, used as identifier]
        """
        return pulumi.get(self, "slack_channel_id")
    ...
    @property
    @pulumi.getter(name="slackChannelName")
    def slack_channel_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the slack channel [global, used as identifier]
        """
        return pulumi.get(self, "slack_channel_name")

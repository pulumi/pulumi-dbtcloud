...
__all__ = ['ProjectArtefactsArgs', 'ProjectArtefacts']

@pulumi.input_type
class ProjectArtefactsArgs:
    def __init__(__self__, *,
                 project_id: pulumi.Input[builtins.int],
                 docs_job_id: Optional[pulumi.Input[builtins.int]] = None,
                 freshness_job_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a ProjectArtefacts resource.
        :param pulumi.Input[builtins.int] project_id: Project ID
        :param pulumi.Input[builtins.int] docs_job_id: Docs Job ID
        :param pulumi.Input[builtins.int] freshness_job_id: Freshness Job ID
        """
        pulumi.set(__self__, "project_id", project_id)
        if docs_job_id is not None:
            pulumi.set(__self__, "docs_job_id", docs_job_id)
        if freshness_job_id is not None:
    ...
    def docs_job_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Docs Job ID
        """
    ...
    @docs_job_id.setter
    def docs_job_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "docs_job_id", value)

    @property
    @pulumi.getter(name="freshnessJobId")
    def freshness_job_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Freshness Job ID
        """
    ...
    def freshness_job_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ProjectArtefacts(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProjectArtefactsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProjectArtefactsArgs.__new__(ProjectArtefactsArgs)

            __props__.__dict__["docs_job_id"] = docs_job_id
            __props__.__dict__["freshness_job_id"] = freshness_job_id
            if project_id is None and not opts.urn:
                raise TypeError("Missing required property 'project_id'")
            __props__.__dict__["project_id"] = project_id
        super(ProjectArtefacts, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            docs_job_id: Optional[pulumi.Input[builtins.int]] = None,
            freshness_job_id: Optional[pulumi.Input[builtins.int]] = None,
            project_id: Optional[pulumi.Input[builtins.int]] = None) -> 'ProjectArtefacts':
        """
        ...
        __props__ = _ProjectArtefactsState.__new__(_ProjectArtefactsState)

        __props__.__dict__["docs_job_id"] = docs_job_id
        __props__.__dict__["freshness_job_id"] = freshness_job_id
        __props__.__dict__["project_id"] = project_id
        return ProjectArtefacts(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="docsJobId")
    def docs_job_id(self) -> pulumi.Output[builtins.int]:
        """
        Docs Job ID
        """
        return pulumi.get(self, "docs_job_id")
    ...
    @property
    @pulumi.getter(name="freshnessJobId")
    def freshness_job_id(self) -> pulumi.Output[builtins.int]:
        """
        Freshness Job ID
        """
        return pulumi.get(self, "freshness_job_id")

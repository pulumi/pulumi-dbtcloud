...
class PartialEnvironmentVariable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        This resource is different from `EnvironmentVariable` as it allows having different resources setting up different environment values for the same environment variable.
    ...
    def get(resource_name: str,
            ...
            environment_values: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project_id: pulumi.Input[Optional[_builtins.int]] = None) -> 'PartialEnvironmentVariable':
        """

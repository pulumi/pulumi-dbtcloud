...
class BigquerySemanticLayerCredentialCredential(dict):
    ...
    def __init__(__self__, *,
                 ...
                 project_id: _builtins.int,
                 connection_id: Optional[_builtins.int] = None,
        ...
        :param _builtins.int connection_id: The ID of the global connection to use for this credential. When provided, the credential will automatically use the correct adapter version based on the connection's configuration (e.g., bigquery*v1 for connections with use*latest_adapter=true).
    ...
    def connection_id(self) -> Optional[_builtins.int]:
        """
...
class DatabricksSemanticLayerCredentialCredential(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str token: Token for Databricks user. Consider using `token_wo` instead, which is not stored in state.
        ...
        :param _builtins.int token_wo_version: Version number for `token_wo`. Increment this value to trigger an update of the token when using `token_wo`.
        """
        pulumi.set(__self__, "project_id", project_id)
...
class GlobalConnectionBigquery(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "deploymentEnvAuthType":
            suggest = "deployment_env_auth_type"
    ...
    def __init__(__self__, *,
                 ...
                 deployment_env_auth_type: Optional[_builtins.str] = None,
        ...
        :param _builtins.str client_id: Client ID of the Service Account. Required when using 'service-account-json' authentication.
        :param _builtins.str client_x509_cert_url: Client X509 Cert URL for the Service Account. Required when using 'service-account-json' authentication.
        ...
        :param _builtins.str deployment_env_auth_type: Authentication type for deployment environments. Can be 'service-account-json' or 'external-oauth-wif'. Defaults to 'service-account-json'.
        ...
        :param _builtins.str private_key: Private Key for the Service Account. Required when using 'service-account-json' authentication.
        :param _builtins.str private_key_id: Private Key ID for the Service Account. Required when using 'service-account-json' authentication.
        ...
        :param _builtins.str token_uri: Token URI for the Service Account. Required when using 'service-account-json' authentication.
    ...
    def deployment_env_auth_type(self) -> Optional[_builtins.str]:
        """
...
class GroupGroupPermission(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str permission_set: The permission set to apply (e.g. `developer`, `analyst`, `account_admin`). See the table at the top of this page for the full list of permission codes.
...
class PostgresSemanticLayerCredentialCredential(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str password: Password for Postgres/Redshift/AlloyDB. Consider using `password_wo` instead, which is not stored in state.
        ...
        :param _builtins.int password_wo_version: Version number for `password_wo`. Increment this value to trigger an update of the password when using `password_wo`.
...
class RedshiftSemanticLayerCredentialCredential(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str password: The password for the Redshift account. Consider using `password_wo` instead, which is not stored in state.
        :param _builtins.str password_wo: **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
               Write-only alternative to `password`. The value is not stored in state. Requires `password_wo_version` to trigger updates.
        :param _builtins.int password_wo_version: Version number for `password_wo`. Increment this value to trigger an update of the password when using `password_wo`.
...
class SnowflakeSemanticLayerCredentialCredential(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "privateKeyPassphraseWo":
            suggest = "private_key_passphrase_wo"
        elif key == "privateKeyPassphraseWoVersion":
            suggest = "private_key_passphrase_wo_version"
    ...
    def __init__(__self__, *,
                 ...
                 private_key_passphrase_wo: Optional[_builtins.str] = None,
                 private_key_passphrase_wo_version: Optional[_builtins.int] = None,
        ...
        :param _builtins.str password: The password for the Snowflake account. Consider using `password_wo` instead, which is not stored in state.
        :param _builtins.str password_wo: **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
               Write-only alternative to `password`. The value is not stored in state. Requires `password_wo_version` to trigger updates.
        :param _builtins.int password_wo_version: Version number for `password_wo`. Increment this value to trigger an update of the password when using `password_wo`.
        :param _builtins.str private_key: The private key for the Snowflake account. Consider using `private_key_wo` instead, which is not stored in state.
        :param _builtins.str private_key_passphrase: The passphrase for the private key. Consider using `private_key_passphrase_wo` instead, which is not stored in state.
        :param _builtins.str private_key_passphrase_wo: **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
        ...
        :param _builtins.int private_key_passphrase_wo_version: Version number for `private_key_passphrase_wo`. Increment this value to trigger an update of the private key passphrase when using `private_key_passphrase_wo`.
        ...
        :param _builtins.int private_key_wo_version: Version number for `private_key_wo`. Increment this value to trigger an update of the private key when using `private_key_wo`.
    ...
    def private_key_passphrase_wo(self) -> Optional[_builtins.str]:
        """
        **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
        Write-only alternative to `private_key_passphrase`. The value is not stored in state. Requires `private_key_passphrase_wo_version` to trigger updates.
        """
    ...
    def private_key_passphrase_wo_version(self) -> Optional[_builtins.int]:
        """
...
class GetGlobalConnectionBigqueryResult(dict):
    def __init__(__self__, *,
                 ...
                 deployment_env_auth_type: _builtins.str,
        ...
        :param _builtins.str dataproc_cluster_name: Dataproc cluster name for PySpark workloads
        :param _builtins.str dataproc_region: Google Cloud region for PySpark workloads on Dataproc
        :param _builtins.str deployment_env_auth_type: Authentication type for deployment environments. Can be 'service-account-json' or 'external-oauth-wif'.
        :param _builtins.str execution_project: Project to bill for query execution
        :param _builtins.str gcp_project_id: The GCP project ID to use for the connection
        :param _builtins.str gcs_bucket: URI for a Google Cloud Storage bucket to host Python code executed via Datapro
        :param _builtins.str impersonate_service_account: Service Account to impersonate when running queries
    ...
    @_builtins.property
    @pulumi.getter(name="deploymentEnvAuthType")
    def deployment_env_auth_type(self) -> _builtins.str:
        """

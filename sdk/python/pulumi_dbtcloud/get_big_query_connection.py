...
class GetBigQueryConnectionResult:
    ...
    def is_configured_for_oauth(self) -> builtins.bool:
        """
...
def get_big_query_connection(connection_id: Optional[builtins.int] = None,
    ...
    :param builtins.int connection_id: Connection Identifier
    :param builtins.int project_id: Project ID to create the connection in
    """
    __args__ = dict()
...
def get_big_query_connection_output(connection_id: Optional[pulumi.Input[builtins.int]] = None,

...
class RepositoryArgs:
    def __init__(__self__, *,
                 ...
                 remote_url: pulumi.Input[builtins.str],
                 azure_active_directory_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 azure_active_directory_repository_id: Optional[pulumi.Input[builtins.str]] = None,
                 azure_bypass_webhook_registration_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 fetch_deploy_key: Optional[pulumi.Input[builtins.bool]] = None,
                 git_clone_strategy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] azure_active_directory_project_id: The Azure Dev Ops project ID. It can be retrieved via the Azure API or using the data source `get_azure_dev_ops_project` and the project name - (for ADO native integration only)
        :param pulumi.Input[builtins.str] azure_active_directory_repository_id: The Azure Dev Ops repository ID. It can be retrieved via the Azure API or using the data source `get_azure_dev_ops_repository` along with the ADO Project ID and the repository name - (for ADO native integration only)
        :param pulumi.Input[builtins.bool] azure_bypass_webhook_registration_failure: If set to False (the default), the connection will fail if the service user doesn't have access to set webhooks (required for auto-triggering CI jobs). If set to True, the connection will be successful but no automated CI job will be triggered - (for ADO native integration only)
        :param pulumi.Input[builtins.bool] fetch_deploy_key: Whether we should return the public deploy key - (for the `deploy_key` strategy)
        :param pulumi.Input[builtins.str] git_clone_strategy: Git clone strategy for the repository. Can be `deploy_key` (default) for cloning via SSH Deploy Key, `github_app` for GitHub native integration, `deploy_token` for the GitLab native integration and `azure_active_directory_app` for ADO native integration
    ...
    def remote_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @remote_url.setter
    def remote_url(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "remote_url", value)

    @property
    @pulumi.getter(name="azureActiveDirectoryProjectId")
    def azure_active_directory_project_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def azure_active_directory_project_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "azure_active_directory_project_id", value)

    @property
    @pulumi.getter(name="azureActiveDirectoryRepositoryId")
    def azure_active_directory_repository_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def azure_active_directory_repository_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "azure_active_directory_repository_id", value)

    @property
    @pulumi.getter(name="azureBypassWebhookRegistrationFailure")
    def azure_bypass_webhook_registration_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def azure_bypass_webhook_registration_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def fetch_deploy_key(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def fetch_deploy_key(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "fetch_deploy_key", value)

    @property
    @pulumi.getter(name="gitCloneStrategy")
    def git_clone_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def git_clone_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "git_clone_strategy", value)

    @property
    @pulumi.getter(name="githubInstallationId")
    def github_installation_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def github_installation_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "github_installation_id", value)

    @property
    @pulumi.getter(name="gitlabProjectId")
    def gitlab_project_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def gitlab_project_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def pull_request_url_template(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RepositoryState:
    def __init__(__self__, *,
                 ...
                 azure_active_directory_repository_id: Optional[pulumi.Input[builtins.str]] = None,
                 azure_bypass_webhook_registration_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 deploy_key: Optional[pulumi.Input[builtins.str]] = None,
                 fetch_deploy_key: Optional[pulumi.Input[builtins.bool]] = None,
                 git_clone_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 github_installation_id: Optional[pulumi.Input[builtins.int]] = None,
                 gitlab_project_id: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 repository_credentials_id: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] azure_active_directory_repository_id: The Azure Dev Ops repository ID. It can be retrieved via the Azure API or using the data source `get_azure_dev_ops_repository` along with the ADO Project ID and the repository name - (for ADO native integration only)
        :param pulumi.Input[builtins.bool] azure_bypass_webhook_registration_failure: If set to False (the default), the connection will fail if the service user doesn't have access to set webhooks (required for auto-triggering CI jobs). If set to True, the connection will be successful but no automated CI job will be triggered - (for ADO native integration only)
        :param pulumi.Input[builtins.str] deploy_key: Public key generated by dbt when using `deploy_key` clone strategy
        :param pulumi.Input[builtins.bool] fetch_deploy_key: Whether we should return the public deploy key - (for the `deploy_key` strategy)
        :param pulumi.Input[builtins.str] git_clone_strategy: Git clone strategy for the repository. Can be `deploy_key` (default) for cloning via SSH Deploy Key, `github_app` for GitHub native integration, `deploy_token` for the GitLab native integration and `azure_active_directory_app` for ADO native integration
        :param pulumi.Input[builtins.int] github_installation_id: Identifier for the GitHub App - (for GitHub native integration only)
        :param pulumi.Input[builtins.int] gitlab_project_id: Identifier for the Gitlab project -  (for GitLab native integration only)
        ...
        :param pulumi.Input[builtins.str] pull_request_url_template: URL template for creating a pull request. If it is not set, the default template will create a PR from the current branch to the branch configured in the Development environment.
        :param pulumi.Input[builtins.str] remote_url: Git URL for the repository or <Group>/<Project> for Gitlab
        :param pulumi.Input[builtins.int] repository_credentials_id: Credentials ID for the repository (From the repository side not the dbt Cloud ID)
        :param pulumi.Input[builtins.int] repository_id: Repository Identifier
        """
        if azure_active_directory_project_id is not None:
            pulumi.set(__self__, "azure_active_directory_project_id", azure_active_directory_project_id)
        if azure_active_directory_repository_id is not None:
    ...
    def deploy_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @deploy_key.setter
    def deploy_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def repository_credentials_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def repository_credentials_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Repository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remote_url: Optional[pulumi.Input[builtins.str]] = None,
            repository_credentials_id: Optional[pulumi.Input[builtins.int]] = None,
            repository_id: Optional[pulumi.Input[builtins.int]] = None) -> 'Repository':
        """
    ...
    @property
    @pulumi.getter(name="deployKey")
    def deploy_key(self) -> pulumi.Output[builtins.str]:
        """
        Public key generated by dbt when using `deploy_key` clone strategy
        """
        return pulumi.get(self, "deploy_key")
    ...
    @property
    @pulumi.getter(name="githubInstallationId")
    def github_installation_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Identifier for the GitHub App - (for GitHub native integration only)
        """
        return pulumi.get(self, "github_installation_id")
    ...
    @property
    @pulumi.getter(name="gitlabProjectId")
    def gitlab_project_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Identifier for the Gitlab project -  (for GitLab native integration only)
        """
        return pulumi.get(self, "gitlab_project_id")
    ...
    @property
    @pulumi.getter(name="pullRequestUrlTemplate")
    def pull_request_url_template(self) -> pulumi.Output[builtins.str]:
        """
        URL template for creating a pull request. If it is not set, the default template will create a PR from the current branch to the branch configured in the Development environment.
        """
        return pulumi.get(self, "pull_request_url_template")
    ...
    @property
    @pulumi.getter(name="repositoryCredentialsId")
    def repository_credentials_id(self) -> pulumi.Output[builtins.int]:
        """
        Credentials ID for the repository (From the repository side not the dbt Cloud ID)
        """
        return pulumi.get(self, "repository_credentials_id")

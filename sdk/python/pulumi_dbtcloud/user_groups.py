...
class UserGroupsArgs:
    def __init__(__self__, *,
                 group_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]],
    ...
    def group_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]:
        """
    ...
    @group_ids.setter
    def group_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]):

...
class GetSynapseCredentialResult:
    ...
    def schema_authorization(self) -> builtins.str:
        """
...
def get_synapse_credential(credential_id: Optional[builtins.int] = None,
...
def get_synapse_credential_output(credential_id: Optional[pulumi.Input[builtins.int]] = None,

...
class GetExtendedAttributesResult:
    ...
    def extended_attributes(self) -> _builtins.str:
        """
        Extended attributes
        """
...
def get_extended_attributes(extended_attributes_id: Optional[_builtins.int] = None,
    ...
    :param _builtins.int extended_attributes_id: Extended attributes ID

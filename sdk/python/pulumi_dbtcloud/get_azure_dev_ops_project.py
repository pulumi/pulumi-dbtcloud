...
def get_azure_dev_ops_project(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the ADO project
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_azure_dev_ops_project_output(name: Optional[pulumi.Input[builtins.str]] = None,

...
class GetConnectionResult:
    ...
    def allow_keep_alive(self) -> builtins.bool:
        """
...
def get_connection(connection_id: Optional[builtins.int] = None,
                   project_id: Optional[builtins.int] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConnectionResult:
    """
    Use this data source to access information about an existing resource.

    :param builtins.int connection_id: ID for the connection
...
def get_connection_output(connection_id: Optional[pulumi.Input[builtins.int]] = None,

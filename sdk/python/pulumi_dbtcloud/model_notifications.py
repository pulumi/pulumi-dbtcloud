...
class ModelNotificationsArgs:
    def __init__(__self__, *,
                 ...
                 on_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 on_skipped: Optional[pulumi.Input[builtins.bool]] = None,
                 on_success: Optional[pulumi.Input[builtins.bool]] = None,
                 on_warning: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ModelNotifications resource.
        :param pulumi.Input[builtins.str] environment_id: The ID of the dbt Cloud environment
        :param pulumi.Input[builtins.bool] enabled: Whether model notifications are enabled for this environment
        :param pulumi.Input[builtins.bool] on_failure: Whether to send notifications for failed model runs
        :param pulumi.Input[builtins.bool] on_skipped: Whether to send notifications for skipped model runs
        :param pulumi.Input[builtins.bool] on_success: Whether to send notifications for successful model runs
        :param pulumi.Input[builtins.bool] on_warning: Whether to send notifications for model runs with warnings
        """
    ...
    def on_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @on_failure.setter
    def on_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "on_failure", value)

    @property
    @pulumi.getter(name="onSkipped")
    def on_skipped(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @on_skipped.setter
    def on_skipped(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "on_skipped", value)

    @property
    @pulumi.getter(name="onSuccess")
    def on_success(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @on_success.setter
    def on_success(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "on_success", value)

    @property
    @pulumi.getter(name="onWarning")
    def on_warning(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @on_warning.setter
    def on_warning(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ModelNotifications(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            on_skipped: Optional[pulumi.Input[builtins.bool]] = None,
            on_success: Optional[pulumi.Input[builtins.bool]] = None,
            on_warning: Optional[pulumi.Input[builtins.bool]] = None) -> 'ModelNotifications':
        """
    ...
    @property
    @pulumi.getter(name="onFailure")
    def on_failure(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to send notifications for failed model runs
        """
        return pulumi.get(self, "on_failure")
    ...
    @property
    @pulumi.getter(name="onSkipped")
    def on_skipped(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to send notifications for skipped model runs
        """
        return pulumi.get(self, "on_skipped")
    ...
    @property
    @pulumi.getter(name="onSuccess")
    def on_success(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to send notifications for successful model runs
        """
        return pulumi.get(self, "on_success")
    ...
    @property
    @pulumi.getter(name="onWarning")
    def on_warning(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to send notifications for model runs with warnings
        """
        return pulumi.get(self, "on_warning")

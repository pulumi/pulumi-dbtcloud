...
//			_, err := dbtcloud.GetNotification(ctx, &dbtcloud.LookupNotificationArgs{
...
func LookupNotificationOutput(ctx *pulumi.Context, args LookupNotificationOutputArgs, opts ...pulumi.InvokeOption) LookupNotificationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNotificationResultOutput, error) {
			...
			return ctx.InvokeOutput("dbtcloud:index/getNotification:getNotification", args, LookupNotificationResultOutput{}, options).(LookupNotificationResultOutput), nil

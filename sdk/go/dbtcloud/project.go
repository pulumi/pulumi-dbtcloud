...
func NewProject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("dbtcloud:index/project:Project", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProject(ctx *pulumi.Context,
	...
	var resource Project
	err := ctx.ReadResource("dbtcloud:index/project:Project", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil

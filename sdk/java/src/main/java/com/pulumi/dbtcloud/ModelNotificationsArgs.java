...
public final class ModelNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModelNotificationsArgs Empty = new ModelNotificationsArgs();
    ...
    private ModelNotificationsArgs() {}

    private ModelNotificationsArgs(ModelNotificationsArgs $) {
    ...
    public static Builder builder(ModelNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelNotificationsArgs();
        }

        public Builder(ModelNotificationsArgs defaults) {
            $ = new ModelNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ModelNotificationsArgs build() {
            if ($.environmentId == null) {
                throw new MissingRequiredPropertyException("ModelNotificationsArgs", "environmentId");
            }
            return $;
        }
    }

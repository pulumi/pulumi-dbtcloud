...
public class GroupPartialPermissions extends com.pulumi.resources.CustomResource {
     ...
     */
    public GroupPartialPermissions(String name) {
     ...
     */
    public GroupPartialPermissions(String name, @Nullable GroupPartialPermissionsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GroupPartialPermissions(String name, @Nullable GroupPartialPermissionsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dbtcloud:index/groupPartialPermissions:GroupPartialPermissions", name, args == null ? GroupPartialPermissionsArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private GroupPartialPermissions(String name, Output<String> id, @Nullable GroupPartialPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dbtcloud:index/groupPartialPermissions:GroupPartialPermissions", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static GroupPartialPermissions get(String name, Output<String> id, @Nullable GroupPartialPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

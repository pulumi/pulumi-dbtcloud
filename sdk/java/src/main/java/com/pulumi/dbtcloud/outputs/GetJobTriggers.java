...
@CustomType
public final class GetJobTriggers {
    /**
    ...
    public static Builder builder(GetJobTriggers defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean schedule;
        public Builder() {}
        public Builder(GetJobTriggers defaults) {
        ...
        public Builder gitProviderWebhook(Boolean gitProviderWebhook) {
            if (gitProviderWebhook == null) {
              throw new MissingRequiredPropertyException("GetJobTriggers", "gitProviderWebhook");
            }
        ...
        public Builder githubWebhook(Boolean githubWebhook) {
            if (githubWebhook == null) {
              throw new MissingRequiredPropertyException("GetJobTriggers", "githubWebhook");
            }
        ...
        public Builder onMerge(Boolean onMerge) {
            if (onMerge == null) {
              throw new MissingRequiredPropertyException("GetJobTriggers", "onMerge");
            }
        ...
        public Builder schedule(Boolean schedule) {
            if (schedule == null) {
              throw new MissingRequiredPropertyException("GetJobTriggers", "schedule");
            }
            this.schedule = schedule;
            return this;
        }
        public GetJobTriggers build() {
            final var _resultValue = new GetJobTriggers();

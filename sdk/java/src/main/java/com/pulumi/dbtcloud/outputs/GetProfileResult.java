    ...
    public static final class Builder {
        ...
        public Builder connectionId(Integer connectionId) {
            if (connectionId == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "connectionId");
            }
        ...
        public Builder credentialsId(Integer credentialsId) {
            if (credentialsId == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "credentialsId");
            }
        ...
        public Builder extendedAttributesId(Integer extendedAttributesId) {
            if (extendedAttributesId == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "extendedAttributesId");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder projectId(Integer projectId) {
            if (projectId == null) {
              throw new MissingRequiredPropertyException("GetProfileResult", "projectId");
            }

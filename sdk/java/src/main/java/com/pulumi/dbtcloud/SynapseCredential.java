...
import com.pulumi.dbtcloud.inputs.SynapseCredentialState;
 ...
 * 
 */
@ResourceType(type="dbtcloud:index/synapseCredential:SynapseCredential")
public class SynapseCredential extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public SynapseCredential(java.lang.String name) {
        this(name, SynapseCredentialArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SynapseCredential(java.lang.String name, SynapseCredentialArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SynapseCredential(java.lang.String name, SynapseCredentialArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dbtcloud:index/synapseCredential:SynapseCredential", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SynapseCredential(java.lang.String name, Output<java.lang.String> id, @Nullable SynapseCredentialState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dbtcloud:index/synapseCredential:SynapseCredential", name, state, makeResourceOptions(options, id), false);
    }

    private static SynapseCredentialArgs makeArgs(SynapseCredentialArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SynapseCredentialArgs.Empty : args;
    }
     ...
     */
    public static SynapseCredential get(java.lang.String name, Output<java.lang.String> id, @Nullable SynapseCredentialState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

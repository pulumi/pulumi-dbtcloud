...
public final class GroupPartialPermissionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupPartialPermissionsArgs Empty = new GroupPartialPermissionsArgs();
    ...
    private GroupPartialPermissionsArgs() {}

    private GroupPartialPermissionsArgs(GroupPartialPermissionsArgs $) {
    ...
    public static Builder builder(GroupPartialPermissionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupPartialPermissionsArgs();
        }

        public Builder(GroupPartialPermissionsArgs defaults) {
            $ = new GroupPartialPermissionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupPartialPermissionsArgs build() {
            return $;
        }
    }

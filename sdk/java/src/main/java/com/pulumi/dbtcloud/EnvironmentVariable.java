...
public class EnvironmentVariable extends com.pulumi.resources.CustomResource {
     ...
     */
    public EnvironmentVariable(String name, EnvironmentVariableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dbtcloud:index/environmentVariable:EnvironmentVariable", name, args == null ? EnvironmentVariableArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EnvironmentVariable(String name, Output<String> id, @Nullable EnvironmentVariableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dbtcloud:index/environmentVariable:EnvironmentVariable", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static EnvironmentVariable get(String name, Output<String> id, @Nullable EnvironmentVariableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {

...
@CustomType
public final class ServiceTokenServiceTokenPermission {
    /**
    ...
    public static Builder builder(ServiceTokenServiceTokenPermission defaults) {
    ...
    public static final class Builder {
        ...
        public Builder allProjects(Boolean allProjects) {
            if (allProjects == null) {
              throw new MissingRequiredPropertyException("ServiceTokenServiceTokenPermission", "allProjects");
            }
        ...
        public Builder permissionSet(String permissionSet) {
            if (permissionSet == null) {
              throw new MissingRequiredPropertyException("ServiceTokenServiceTokenPermission", "permissionSet");
            }

...
public final class GlobalConnectionFabricArgs extends com.pulumi.resources.ResourceArgs {

    public static final GlobalConnectionFabricArgs Empty = new GlobalConnectionFabricArgs();
    ...
    private GlobalConnectionFabricArgs() {}

    private GlobalConnectionFabricArgs(GlobalConnectionFabricArgs $) {
    ...
    public static Builder builder(GlobalConnectionFabricArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GlobalConnectionFabricArgs();
        }

        public Builder(GlobalConnectionFabricArgs defaults) {
            $ = new GlobalConnectionFabricArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GlobalConnectionFabricArgs build() {
            if ($.database == null) {
                throw new MissingRequiredPropertyException("GlobalConnectionFabricArgs", "database");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("GlobalConnectionFabricArgs", "server");
            }
            return $;
        }
    }

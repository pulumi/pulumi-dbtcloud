...
export class OauthConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly applicationIdUri: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: OauthConfigurationArgs | OauthConfigurationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["applicationIdUri"] = state?.applicationIdUri;
            ...
            resourceInputs["applicationIdUri"] = args?.applicationIdUri;

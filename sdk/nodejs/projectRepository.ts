 ...
 * ```
 */
export class ProjectRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectRepositoryState, opts?: pulumi.CustomResourceOptions): ProjectRepository {
        return new ProjectRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dbtcloud:index/projectRepository:ProjectRepository';

    /**
     * Returns true if the given object is an instance of ProjectRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ProjectRepository {
    ...
    constructor(name: string, argsOrState?: ProjectRepositoryArgs | ProjectRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProjectRepositoryState | undefined;
            resourceInputs["projectId"] = state ? state.projectId : undefined;
            resourceInputs["repositoryId"] = state ? state.repositoryId : undefined;
        } else {
            const args = argsOrState as ProjectRepositoryArgs | undefined;

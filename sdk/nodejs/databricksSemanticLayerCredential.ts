...
export class DatabricksSemanticLayerCredential extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.DatabricksSemanticLayerCredentialConfiguration>;
    /**
     * Databricks credential details, but used in the context of the Semantic Layer.
     */
    public readonly credential!: pulumi.Output<outputs.DatabricksSemanticLayerCredentialCredential>;

...
export class ProjectConnection extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectConnectionState, opts?: pulumi.CustomResourceOptions): ProjectConnection {
        return new ProjectConnection(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dbtcloud:index/projectConnection:ProjectConnection';
    ...
    constructor(name: string, argsOrState?: ProjectConnectionArgs | ProjectConnectionState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ProjectConnectionState | undefined;
            resourceInputs["connectionId"] = state ? state.connectionId : undefined;
            resourceInputs["projectId"] = state ? state.projectId : undefined;
        } else {
            const args = argsOrState as ProjectConnectionArgs | undefined;
